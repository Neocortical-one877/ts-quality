...
export declare function renderGovernance(rootDir: string): string;
export declare function renderPlan(rootDir: string): string;
export declare function runAuthorize(rootDir: string, agentId: string, action: string): {
    decisionPath: string;
    output: string;
};
...
export declare function runAmend(rootDir: string, proposalFile: string, apply?: boolean): string;
